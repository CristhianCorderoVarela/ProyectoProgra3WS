...
public class Producto implements Serializable {
    ...
    public GrupoProducto getGrupo() { return grupo; }
    public void setGrupo(GrupoProducto grupo) { this.grupo = grupo; }
    ...
    public String getMenuRapido() { return menuRapido; }
    public void setMenuRapido(String menuRapido) { this.menuRapido = menuRapido; }
    ...
    public boolean isMenuRapido() { return "S".equals(this.menuRapido); }
